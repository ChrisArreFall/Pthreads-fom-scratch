    ...
    switch (metodoFlujo){
            ...
            while(lado<2){
                ...
                if(lado == 0){
                    ...
                    if(schedulerType==1){
                        ...
                        if(schedulerType==2) printf("Scheduler elegido es prioridad!\n");
                        if(schedulerType==3) printf("Scheduler elegido es mas corto primero!\n");
                        if(schedulerType==4) printf("Scheduler elegido es fifo!\n");
                        posInLista = 0;
                        printf("Empieza el while.\n");
        ...
        case 3:
            while(lado<2){
                ...
                //como es equidad se ejecuta dos veces uno para la derecha otro para la izquierda
                //pero como es aleatorio, pasaran n paquetes donde n es un numero que es calculado aleatoriamente
                int n = (abs(rand()) % 5);
                int paquetesEnviados = 0;
